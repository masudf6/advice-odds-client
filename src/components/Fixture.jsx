...
const Fixture = ({ fixture }) => {
  ...
  return (
    <>
      ...
      <TableContainer component={Paper} elevation={10} sx={{marginBottom: '2em', background: 'transparent', minWidth: '100%'}}>
        <Table sx={{tableLayout: 'fixed'}}>
          <TableHead sx={{fontWeight: 'bold'}}>
            <TableRow>
              ...
              <TableCell align="left"><Box sx={{fontWeight: 'bold', textTransform: 'uppercase'}}>Odds <img alt='bet365'/></Box></TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
